...
tbl %>%
  ...
  annotate("text", x = 49, y = -.26, label = glue("negative"), 
    angle = 90, col="darkgray") +
  annotate("text", x = 49, y = .125, label = glue("inconclusive"), 
    angle = 90, col="darkgray") +
  annotate("text", x = 49, y = .425, label = glue("positive"), 
    angle = 90, col="darkgray") +
  coord_cartesian(xlim = c(48.5, 11.75 )) +
  theme_bw() +
